...
# The movie template/index page
def index(request):
    print("Movies index endpoint")
    return render(request, 'cwApp/movies.html', {'allMovies': movies})


# Display another choosen entry
def details(request, movie_id):
    print("Movies Details")
    return render(request, 'cwApp/movie_details.html', {'allMovies': movies[movie_id]})


def synopsis(request, movie_id):
    print("Movies Synopsis")
    return render(request, 'cwApp/movie_synopsis.html', {'allMovies': movies[movie_id]})
